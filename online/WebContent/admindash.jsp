...
%>
					...
					<div class="dropdown-menu bg-transparent border-0">
						<a href="users.html" class="dropdown-item">See Result</a>
						 <a href="addusers.html" class="dropdown-item">Send Student Result Pdf</a>
							 <a href="deletesuers.html" class="dropdown-item">Remove
							Student Result </a>
					</div>
				</div>
	...
	<div>
	<img src="https://www.brosistech.com/wp-content/uploads/2019/05/online-Exam-Portal.jpg" style="background-size: content; width: 100%">
	</div>	
